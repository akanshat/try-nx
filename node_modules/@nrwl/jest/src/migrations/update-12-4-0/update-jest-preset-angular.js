...
function updateASTTransformers(tree, jestConfigPath, jestConfig) {
    ...
    if (newTransformers === null) {
        update_config_1.removePropertyFromJestConfig(tree, jestConfigPath, 'globals.ts-jest.astTransformers');
    }
    else {
        update_config_1.addPropertyToJestConfig(tree, jestConfigPath, 'globals.ts-jest.astTransformers', newTransformers);
    }
}
exports.updateASTTransformers = updateASTTransformers;
function updateTransform(tree, jestConfigPath, jestConfig) {
    update_config_1.removePropertyFromJestConfig(tree, jestConfigPath, 'transform');
    update_config_1.addPropertyToJestConfig(tree, jestConfigPath, 'transform', {
