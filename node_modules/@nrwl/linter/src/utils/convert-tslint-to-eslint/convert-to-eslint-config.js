...
function getConvertToEslintConfig() {
    ...
    child_process_1.execSync(`${devkit_1.getPackageManagerCommand().addDev} tslint-to-eslint-config@${versions_1.tslintToEslintConfigVersion}`, {
        cwd: tempDir,
        stdio: [0, 1, 2],
    });
...
function convertToESLintConfig(pathToTslintJson, tslintJson, ignoreExtendsVals) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (ignoreExtendsVals.length && updatedTSLintJson.extends) {
             ...
             */
            devkit_1.writeJsonFile(pathToTslintJson, updatedTSLintJson);
        }
