...
exports.output = exports.TaskCacheStatus = void 0;
const chalk = require("chalk");
var TaskCacheStatus;
(function (TaskCacheStatus) {
    TaskCacheStatus["NoCache"] = "[no cache]";
    TaskCacheStatus["MatchedExistingOutput"] = "[existing outputs match the cache, left as is]";
    TaskCacheStatus["RetrievedFromCache"] = "[retrieved from cache]";
})(TaskCacheStatus = exports.TaskCacheStatus || (exports.TaskCacheStatus = {}));
/**
...
class CLIOutput {
    ...
    logCommand(message, cacheStatus = TaskCacheStatus.NoCache) {
        this.addNewline();
