...
function moveGenerator(tree, rawSchema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const projectConfig = devkit_1.readProjectConfiguration(tree, rawSchema.projectName);
        check_destination_1.checkDestination(tree, rawSchema, projectConfig);
        const schema = normalize_schema_1.normalizeSchema(tree, rawSchema, projectConfig);
        ...
        update_readme_1.updateReadme(tree, schema);
        update_package_json_1.updatePackageJson(tree, schema);
