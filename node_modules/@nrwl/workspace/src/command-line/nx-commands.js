...
exports.commandsObject = yargs
    ...
    .command('daemon:start', chalk.bold('EXPERIMENTAL: Start the project graph daemon server (either in the background or the current process)'), (yargs) => linkToNxDevAndExamples(withDaemonStartOptions(yargs), 'daemon:start'), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    if (args.background) {
        return client_1.startInBackground();
    }
    return client_1.startInCurrentProcess();
}))
    .command('daemon:stop', chalk.bold('EXPERIMENTAL: Stop the project graph daemon server'), (yargs) => linkToNxDevAndExamples(yargs, 'daemon:stop'), () => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return client_1.stop(); }))
