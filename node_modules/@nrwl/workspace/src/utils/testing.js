...
const testRunner = new testing_1.SchematicTestRunner('@nrwl/workspace', path_1.join(__dirname, '../../generators.json'));
...
testRunner.registerCollection('@nrwl/express', path_1.join(__dirname, '../../../express/generators.json'));
testRunner.registerCollection('@nrwl/react', path_1.join(__dirname, '../../../react/generators.json'));
testRunner.registerCollection('@nrwl/angular', path_1.join(__dirname, '../../../angular/generators.json'));
testRunner.registerCollection('@nrwl/next', path_1.join(__dirname, '../../../next/generators.json'));
testRunner.registerCollection('@nrwl/node', path_1.join(__dirname, '../../../node/generators.json'));
testRunner.registerCollection('@nrwl/nest', path_1.join(__dirname, '../../../nest/generators.json'));
testRunner.registerCollection('@nrwl/web', path_1.join(__dirname, '../../../web/generators.json'));
