...
function getProjectGraphFromHost(host) {
    return project_graph_1.onlyWorkspaceProjects(project_graph_1.createProjectGraph(undefined, undefined, undefined, '3.0'));
}
...
function getFullProjectGraphFromHost(host) {
    return project_graph_1.createProjectGraph(undefined, undefined, undefined, '3.0');
}
