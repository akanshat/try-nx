        ...
        projects.forEach((projectConfig, projectName) => {
            ...
            if (isReactProject) {
                ...
                tsConfig.storybook.files = uniqueArray([
                    ...
                    `${devkit_1.offsetFromRoot(storybookRoot)}node_modules/@nrwl/react/typings/cssmodule.d.ts`,
                    `${devkit_1.offsetFromRoot(storybookRoot)}node_modules/@nrwl/react/typings/image.d.ts`,
                ]);
