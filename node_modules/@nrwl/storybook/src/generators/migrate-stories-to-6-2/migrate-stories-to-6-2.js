...
function findAllComponentsWithStoriesForSpecificProject(tree, projectPath) {
    ...
    moduleFilePaths === null || moduleFilePaths === void 0 ? void 0 : moduleFilePaths.map((moduleFilePath) => {
        ...
        const ngModuleDecorators = find_nodes_1.findNodes(file, ts.SyntaxKind.Decorator);
        ...
        if (!declarationsPropertyAssignment) {
            devkit_1.logger.warn(devkit_1.stripIndents `No components declared in ${moduleFilePath}.`);
        }
        ...
        if (!declarationArray) {
            ...
            const variableDeclaration = (_h = find_nodes_1.findNodes(file, typescript_1.SyntaxKind.VariableDeclaration)) === null || _h === void 0 ? void 0 : _h.find((variableDeclaration) => {
                var _a;
        ...
        let componentInfo = declaredComponents === null || declaredComponents === void 0 ? void 0 : declaredComponents.map((componentName) => {
            ...
            try {
                ...
                let componentImportPath = path_1.join(path_1.normalize(fullCmpImportPath), fullPath);
                let path = null;
                ...
                devkit_1.visitNotIgnoredFiles(tree, componentImportPath, (componentFilePath) => {
                ...
                if (path !== null) {
                    ...
                    if (fileutils_1.fileExists(componentStoryPath)) {
                        return {
                            componentName: componentName,
...
function changeSyntaxOfStory(tree, storyFilePath) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const storiesVariableDeclaration = find_nodes_1.findNodes(file, [
            ts.SyntaxKind.VariableDeclaration,
        ]);
        const storiesExportDefault = find_nodes_1.findNodes(file, [
        ...
        storiesVariableDeclaration === null || storiesVariableDeclaration === void 0 ? void 0 : storiesVariableDeclaration.forEach((oneStory) => {
            ...
            if (hasComponentDeclared) {
                ...
                if (hasComponentDeclared.getText() === firstComponentNode.getText()) {
                    ...
                    newContents = devkit_1.applyChangesToString(newContents, [
                        {
...
exports.migrateStoriesSchematic = devkit_1.convertNxGenerator(migrateStoriesTo62Generator);
