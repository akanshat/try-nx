...
function getCommonConfig(wco) {
    ...
    if (scriptsOptimization) {
        ...
        const es5TerserOptions = Object.assign(Object.assign({}, terserOptions), { compress: Object.assign(Object.assign({}, terserOptions.compress), { ecma: 5 }), output: Object.assign(Object.assign({}, terserOptions.output), { ecma: 5 }), mangle: !mangle_options_1.manglingDisabled && buildOptions.platform !== 'server' });
        extraMinimizers.push(new TerserPlugin(!isWebpack5
            ? {
                sourceMap: scriptsSourceMap,
                parallel: true,
                cache: true,
