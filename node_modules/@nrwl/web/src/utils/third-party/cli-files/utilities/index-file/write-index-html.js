...
function writeIndexHtml({ outputPath, indexPath, files = [], noModuleFiles = [], moduleFiles = [], baseHref, deployUrl, sri = false, scripts = [], styles = [], postTransform, crossOrigin, }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        let content = fs_1.readFileSync(indexPath).toString();
        content = strip_bom_1.stripBom(content);
        content = augment_index_html_1.augmentIndexHtml({
            input: outputPath,
            inputContent: interpolate_env_variables_to_index_1.interpolateEnvironmentVariablesToIndex(content, deployUrl),
            baseHref,
            deployUrl,
            crossOrigin,
            sri,
            ...
            loadOutputFile: (filePath) => fs_1.readFileSync(path_1.join(path_1.dirname(outputPath), filePath)).toString(),
        });
        if (postTransform) {
