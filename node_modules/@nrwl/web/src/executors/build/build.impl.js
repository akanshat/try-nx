...
function run(options, context) {
    return tslib_1.__asyncGenerator(this, arguments, function* run_1() {
        ...
        if (!options.buildLibsFromSource && context.targetName) {
            const { dependencies } = buildable_libs_utils_1.calculateProjectDependencies(project_graph_1.readCachedProjectGraph(), context.root, context.projectName, context.targetName, context.configurationName);
