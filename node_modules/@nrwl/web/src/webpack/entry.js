...
const result = require_shim_1.requireShim('webpack/package.json');
...
if (exports.isWebpack5) {
    if (!hasLogged) {
        devkit_1.logger.info(`NX Using webpack 5. Reason: detected version 5 in node_modules/webpack/package.json`);
        hasLogged = true;
    }
