...
function hookGenerator(host, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return yield devkit_1.formatFiles(host);
    });
}
exports.hookGenerator = hookGenerator;
function createFiles(host, options) {
    const hookDir = devkit_1.joinPathFragments(options.projectSourceRoot, options.directory);
    devkit_1.generateFiles(host, devkit_1.joinPathFragments(__dirname, './files'), hookDir, Object.assign(Object.assign({}, options), { tmpl: '' }));
...
function normalizeOptions(host, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const { className, fileName } = devkit_1.names(base);
...
function getDirectory(host, options, baseHookName) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const { className, fileName } = devkit_1.names(baseHookName);
        ...
        return options.flat ? baseDir : devkit_1.joinPathFragments(baseDir, hookFileName);
    });
}
...
exports.hookSchematic = devkit_1.convertNxGenerator(hookGenerator);
