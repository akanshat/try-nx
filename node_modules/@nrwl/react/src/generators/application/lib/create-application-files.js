...
function updateTsConfig(host, options) {
    devkit_1.updateJson(host, devkit_1.joinPathFragments(options.appProjectRoot, 'tsconfig.json'), (json) => {
        if (options.strict) {
